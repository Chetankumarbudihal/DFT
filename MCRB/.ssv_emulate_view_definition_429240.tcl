...
create_library_set -name default_emulate_libset_max -timing [list LIB/NangateOpenCellLibrary_slow_conditional_ccs.lib]
create_library_set -name default_emulate_libset_min -timing [list LIB/NangateOpenCellLibrary_slow_conditional_ccs.lib]

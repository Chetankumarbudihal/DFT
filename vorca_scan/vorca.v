module vorca (clk, i_reset_, i_sw_init, i_addr, i_wr_strb, 
 ...
 test_si1, test_so1, scan_enable, raw_scan_en );
  ...
  input clk, i_reset_, i_sw_init, i_wr_strb, i_rd_strb, test_se,
 ...
 scan_iso_or6, scan_iso_or7, scan_iso_or8, scan_iso_or9;
  output [0:0] test_so1;
 ...
 scan_iso_or9), .test_si(o_reg_read), .scan_enable(scan_enable) );
  TLATNCAX1 clk_gate_mux ( .CLK(clk), .EN(N421), .ENCLK(net121966),  .test_se(scan_enable) );
  TLATNCAX1 clk_gate_addr ( .CLK(clk), .EN(N410), .ENCLK(net121972),  .test_se(scan_enable) );
  TLATNCAX1 clk_gate_data ( .CLK(clk), .EN(i_wr_strb), .ENCLK(net121977),  .test_se( scan_enable) );
...
module survik (clk, i_reset_, i_sw_init, o_spare_config, 
 ...
 w_load_dbg_config, test_se, test_si, scan_enable;
  ...
  TLATNCAX1 clk_gate_spare_config ( .CLK(clk), .EN(w_load_spare_config), .ENCLK(net121994), .test_se(scan_enable) );
  TLATNCAX1 clk_gate_config ( .CLK(clk), .EN(w_load_adj_config), .ENCLK(net122000), .test_se(scan_enable) );
